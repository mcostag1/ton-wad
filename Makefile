...
pkgdatadir = $(datadir)/apertium-ton-wad
pkgincludedir = $(includedir)/apertium-ton-wad
pkglibdir = $(libdir)/apertium-ton-wad
pkglibexecdir = $(libexecdir)/apertium-ton-wad
...
am__installdirs = "$(DESTDIR)$(apertium_ton_waddir)"
DATA = $(apertium_ton_wad_DATA) $(noinst_DATA)
...
ACLOCAL = ${SHELL} /home/swatstudent/Source/ling073-ton-wad/missing aclocal-1.14
AMTAR = $${TAR-tar}
...
AP_SRC1 = ../ling073-ton
AP_SRC2 = ../ling073-wad
AP_SUBDIRS =  ../ling073-ton ../ling073-wad
AUTOCONF = ${SHELL} /home/swatstudent/Source/ling073-ton-wad/missing autoconf
AUTOHEADER = ${SHELL} /home/swatstudent/Source/ling073-ton-wad/missing autoheader
AUTOMAKE = ${SHELL} /home/swatstudent/Source/ling073-ton-wad/missing automake-1.14
AWK = gawk
CGCOMP = /usr/bin/cg-comp
CGPROC = /usr/bin/cg-proc
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"Apertium\ Tongan-wad\" -DPACKAGE_TARNAME=\"apertium-ton-wad\" -DPACKAGE_VERSION=\"0.2.0\" -DPACKAGE_STRING=\"Apertium\ Tongan-wad\ 0.2.0\" -DPACKAGE_BUGREPORT=\"mcostag1@swarthmore.edu\" -DPACKAGE_URL=\"http://wiki.apertium.org/wiki/Apertium-ton-wad\" -DPACKAGE=\"apertium-ton-wad\" -DVERSION=\"0.2.0\"
ECHO_C = 
ECHO_N = -n
ECHO_T = 
...
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/swatstudent/Source/ling073-ton-wad/missing makeinfo
MKDIR_P = /bin/mkdir -p
PACKAGE = apertium-ton-wad
PACKAGE_BUGREPORT = mcostag1@swarthmore.edu
PACKAGE_NAME = Apertium Tongan-wad
PACKAGE_STRING = Apertium Tongan-wad 0.2.0
PACKAGE_TARNAME = apertium-ton-wad
PACKAGE_URL = http://wiki.apertium.org/wiki/Apertium-ton-wad
...
VERSION = 0.1.0
ZCAT = /bin/zcat
abs_builddir = /home/swatstudent/Source/ling073-ton-wad
abs_srcdir = /home/swatstudent/Source/ling073-ton-wad
abs_top_builddir = /home/swatstudent/Source/ling073-ton-wad
abs_top_srcdir = /home/swatstudent/Source/ling073-ton-wad
am__leading_dot = .
...
install_sh = ${SHELL} /home/swatstudent/Source/ling073-ton-wad/install-sh
...
###############################################################################
###############################################################################
apertium_ton_waddir = $(prefix)/share/apertium/$(BASENAME)/

# Files which should be installed to $(prefix)/share/apertium/$(BASENAME)/:
apertium_ton_wad_DATA = \
	$(TARGETS_COMMON)				\
	$(BASENAME).$(PREFIX1).t1x			\
	$(BASENAME).$(PREFIX1).t2x			\
	$(BASENAME).$(PREFIX1).t3x			\
...
$(am__aclocal_m4_deps):
install-apertium_ton_wadDATA: $(apertium_ton_wad_DATA)
	@$(NORMAL_INSTALL)
	@list='$(apertium_ton_wad_DATA)'; test -n "$(apertium_ton_waddir)" || list=; \
	if test -n "$$list"; then \
	  echo " $(MKDIR_P) '$(DESTDIR)$(apertium_ton_waddir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(apertium_ton_waddir)" || exit 1; \
	fi; \
	for p in $$list; do \
	...
	while read files; do \
	  echo " $(INSTALL_DATA) $$files '$(DESTDIR)$(apertium_ton_waddir)'"; \
	  $(INSTALL_DATA) $$files "$(DESTDIR)$(apertium_ton_waddir)" || exit $$?; \
	done

uninstall-apertium_ton_wadDATA:
	@$(NORMAL_UNINSTALL)
	@list='$(apertium_ton_wad_DATA)'; test -n "$(apertium_ton_waddir)" || list=; \
	files=`for p in $$list; do echo $$p; done | sed -e 's|^.*/||'`; \
	dir='$(DESTDIR)$(apertium_ton_waddir)'; $(am__uninstall_files_from_dir)
tags TAGS:
...
installdirs:
	for dir in "$(DESTDIR)$(apertium_ton_waddir)"; do \
...
install-data-am: install-apertium_ton_wadDATA install-data-local
...
uninstall-am: uninstall-apertium_ton_wadDATA
...
.PHONY: all all-am am--refresh check check-am clean clean-generic \
	...
	install install-am install-apertium_ton_wadDATA install-data \
...
test: all
	echo "house" | apertium -d . ton-wad | tee .test-mt
	@echo "house" > .test-ref
	@diff .test-ref .test-mt
	echo "house" | apertium -d . wad-ton | tee .test-mt
	@echo "house" > .test-ref
	@diff .test-ref .test-mt
	@rm .test-ref .test-mt
